...
cnn_model.save("modelo_cnn_1000.h5")
print("Modelo guardado como modelo_cnn_1000.h5")
...
plt.title('Loss during Training and Validation', fontsize=21)
plt.xticks(fontsize=22)  # Aumenta el tamaño de los nombres en el eje X
plt.yticks(fontsize=22)  # Aumenta el tamaño de los nombres en el eje Y
...
plt.title('Accuracy during Training and Validation', fontsize=21)
plt.xticks(fontsize=22)  # Aumenta el tamaño de los nombres en el eje X
plt.yticks(fontsize=22)  # Aumenta el tamaño de los nombres en el eje Y
plt.xlabel('Epochs', fontsize=18)
...
def compute_metrics(X_test, y_test, model, malware_names, output_file="metrics_results_CNN_custom1000.csv", output_image="metrics_by_class_CNN_custom1000.png"):
    ...
    plt.xticks(fontsize=20)  # Aumenta el tamaño de los nombres en el eje X
    plt.yticks(fontsize=20)  # Aumenta el tamaño de los nombres en el eje Y
...
def plot_confusion_matrix(y_test, y_pred, malware_names, output_file="confusion_matrix_CNN_custom1000.png"):
    ...
    plt.xticks(fontsize=16)  # Aumenta el tamaño de los nombres en el eje X
    plt.yticks(fontsize=16)  # Aumenta el tamaño de los nombres en el eje Y
