...
if n_classes == 2:
    ...
    xgb_model = XGBClassifier(
        objective="multi:softmax", num_class=n_classes, n_estimators=300,
...
print("Scaler, LDA y XGB guardados.")
...
def calculate_metrics(y_test, y_pred, malware_names, output_file="metrics_results_LDA+XGB1000.csv", image_output="metrics_per_class_LDA+XGB1000.png"):
    """
...
deployment_metrics = base_run_metadata('LDA+XGB', 'VM-family', 42)
...
save_metrics(deployment_metrics, csv_path='deployment_metrics_vm_family.csv', json_path='deployment_metrics_LDA_XGB_vm_family.json')
