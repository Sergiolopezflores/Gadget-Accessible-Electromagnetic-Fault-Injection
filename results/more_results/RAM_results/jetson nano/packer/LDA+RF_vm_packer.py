...
deployment_metrics = base_run_metadata('LDA+RF', 'VM-packer', 42)
...
save_metrics(deployment_metrics, csv_path='deployment_metrics_vm_packer.csv', json_path='deployment_metrics_LDA_RF_vm_packer.json')
