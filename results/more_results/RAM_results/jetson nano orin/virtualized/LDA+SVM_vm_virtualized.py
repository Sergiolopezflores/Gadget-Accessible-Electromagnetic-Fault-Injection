...
deployment_metrics = base_run_metadata('LDA+SVM', 'VM-virtualized', 42)
...
save_metrics(deployment_metrics, json_path='deployment_metrics_LDA_SVM_vm_virtualized.json')
