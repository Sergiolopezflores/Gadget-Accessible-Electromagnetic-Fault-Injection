...
deployment_metrics = base_run_metadata('LDA+SVM', 'VM-family', 42)
...
save_metrics(deployment_metrics, csv_path='deployment_metrics_vm_family.csv', json_path='deployment_metrics_LDA_SVM_vm_family.json')
