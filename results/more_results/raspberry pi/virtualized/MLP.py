...
best_history = mlp_model.fit(X_train, y_train, validation_data=(X_test, y_test), epochs=100, batch_size=32)
...
mlp_model.save("modelo_mlp_1000.h5")
print("Modelo guardado como modelo_mlp_1000.h5")
