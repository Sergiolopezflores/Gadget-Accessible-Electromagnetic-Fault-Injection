...
malware_names = ["virtualized", "not_virtualized"]
...
improved_model.save("modelo_rnn_1000.h5")
print("Modelo guardado como modelo_rnn_1000.h5")
...
def compute_metrics(X_test, y_test, model, malware_names, output_file="metrics_results_RNN_custom1000.csv", image_output="class_metrics_RNN_custom1000.png"):
...
def plot_confusion_matrix(y_test, y_pred, malware_names, output_file="confusion_matrix_RNN_custom1000.png"):
