...
def plot_confusion_matrix(y_test, y_pred, malware_names, output_file="confusion_matrix_LDA+SVM.png"):
...
def calculate_metrics(y_test, y_pred, malware_names, output_file="metrics_results_LDA+SVM.csv", image_output="metrics_per_class_LDA+SVM.png"):
    """
