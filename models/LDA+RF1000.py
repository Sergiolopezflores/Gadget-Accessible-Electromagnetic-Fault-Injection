...
# Convertir etiquetas de one-hot a índices
...
def graficar_matriz_confusion(y_test, y_pred, nombres_malware, archivo_salida="matriz_confusion_LDA+RF_casero.png"):
...
def calcular_métricas(y_test, y_pred, nombres_malware, archivo_salida="resultados_métricas_LDA+RandomForest1000.csv", imagen_salida="metricas_por_clase_LDA+RandomForest1000.png"):
    """
